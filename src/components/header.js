    ...
    <>
     <header>
      <div className="fixed-header w-100 m-0">
          <p className="text-center josefin-sans-sb primary-color p-2" style={{fontSize:'1.4rem'}}>Free local shipping within the GTA for orders over $45</p>
      </div>  
      <Navbar color="light" light={true} expand="lg" className="bg-transparent p-3 p-sm-0 sticky-header">
      	<Container>
          <div className="navbar-start m-0 logo-box mt-3">
          
              <Link aria-label="search" className="has-text-black has-text-weight-bold" to="/">
                <img src={logo} alt="" className="img-fluid"/>
              </Link>
            
          </div>
          <NavbarToggler onClick={toggle} style={{padding:'0.25rem 0.5rem', fontSize:'1rem'}} />
          <div className="d-lg-flex w-100">
          
          		<Collapse isOpen={isOpen} navbar className="text-center text-lg-left">
              <Nav className="mr-0 ml-auto josefin-sans py-0 w-100 text-center d-lg-block" navbar>
                <NavItem className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                  <Link to="/collections/essentials/" onClick={closeNav} className="space-1 p-sm-0 p-lg-0 p-xl-0 nav-link font-weight-bold">
                    Essential
                  </Link>
                </NavItem>
                <NavItem className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                  <Link to="/collections/fragrant/" onClick={closeNav} className="space-1 p-sm-0 p-lg-0 p-xl-0 nav-link font-weight-bold">
                    Fragrant
                  </Link>
                </NavItem>
                <NavItem className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                  <Link to="/collections/figure/" onClick={closeNav} className="space-1 p-sm-0 p-lg-0 p-xl-0 nav-link font-weight-bold">
                    Figure
                  </Link>
                </NavItem>
                <NavItem className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                  <Link to="/collections/donut/" onClick={closeNav} className="space-1 p-sm-0 p-lg-0 p-xl-0 nav-link font-weight-bold">
                    Donut
                  </Link>
                </NavItem>
                <NavItem className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                  <Link to="/collections/bath-bath-bomb/" className="space-1 p-sm-0 p-lg-0 p-xl-0 nav-link font-weight-bold">
                    Bath bombs
                  </Link>
                </NavItem>
                <NavItem className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                  <Link to="/collections/treat/" onClick={closeNav} className="space-1 p-sm-0 p-lg-0 p-xl-0 nav-link font-weight-bold">
                    Treat
                  </Link>
                </NavItem>
                <NavItem className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                  <Link to="/collections/gift/" onClick={closeNav} className="space-1 p-sm-0 p-lg-0 p-xl-0 nav-link font-weight-bold">
                    Gift
                  </Link>
                </NavItem>
        ...
        <div className="modal-content bg-transparent">
          <div className="field">
            <div className="control has-icons-right">
              <form action="../search" method="GET" className="col-10 col-lg-6 mx-auto">
                <input className="input is-large josefin-sans-sb" name="value" type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search" aria-label="Search"/>
                <span className="icon is-right">
                  <FontAwesomeIcon icon={faSearch} />
                </span>
                <label className="has-text-white w-100 text-center mt-3 josefin-sans-sb">ENTER ↵</label>
              </form>
            </div>
          </div>
        </div>
