            ...
            <>
              ...
              <footer className="footer">
                <div className="content has-text-centered">
                  <p>
                    <strong>Gatsby x Shopify</strong> by{" "}
                    <a
                      className="has-text-danger"
                      href="https://www.alexislepresle.com"
                      target="_blank"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/alexislepresle/Gatsby-E-commerce-course"
                  >
                    Github
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://school.alexislepresle.com/courses/build-an-ecommerce-website-with-gatsby-js-1/"
                  >
                    Online Course
                  </a>
                </div>
